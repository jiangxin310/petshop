...
public class NVPAPICaller
{
    ...
    public string APIUsername = "435878393@qq.com";
    private string APIPassword = "bz292929";
    private string APISignature = "07628423127964296915";
    ...
    public bool ShortcutExpressCheckout(string amt, ref string token, ref string retMsg)
    {
        ...
        string returnURL = "http://localhost:10438/Checkout/CheckoutReview.aspx";
        string cancelURL = "http://localhost:10438/Checkout/CheckoutCancel.aspx";
        ...
        petshop.Logic.ShoppingCartActions myCartOrders = new petshop.Logic.ShoppingCartActions();
    ...
    public string HttpCall(string NvpRequest)
    {
        ...
        catch (Exception e)
        {
            ...
            // Log the exception.
            petshop.Logic.ExceptionUtility.LogException(e,"HttpCall in PayPalFunction.cs");
        }
